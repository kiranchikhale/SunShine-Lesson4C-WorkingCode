...
import app.com.example.kiran.sunshine.FetchWeatherTask;
...
public class TestFetchWeatherTask extends AndroidTestCase {
    ...
    public void testAddLocation() {
        ...
        long locationId;
        locationId = fwt.addLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
        ...
        for ( int i = 0; i < 2; i++ ) {
            ...
            long newLocationId;
            newLocationId = fwt.addLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
                    ADD_LOCATION_LAT, ADD_LOCATION_LON);
